export const helptextsNb = {
  ...
  dataControllerRepresentativeInEUDescription: `En “representant” en fysisk eller juridisk person som er etablert i Unionen, som den behandlingsansvarlige har utpekt skriftlig i henhold til artikkel 27, og som representerer den behandlingsansvarlige eller databehandleren med hensyn til de forpliktelser de har i henhold til personvernforordningen. Les mer på [Datatilsynets nettsider](https://www.datatilsynet.no/rettigheter-og-plikter/virksomhetenes-plikter/behandlingsgrunnlag/veileder-om-behandlingsgrunnlag/?id=10832)`,
